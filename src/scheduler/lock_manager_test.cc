...
/// @section DESCRIPTION
///
/// Deterministic lock manager testing

#include "scheduler/lock_manager.h"

/// @TODO fix lock manager testing
...
//  TEST(LockManagerTest, SimpleLocking) {
//    deque<TxnProto*> ready_txns;
//    LockManager lm(&ready_txns);
...
//  TEST(LockManagerTest, LocksReleasedOutOfOrder) {
//    deque<TxnProto*> ready_txns;
//    LockManager lm(&ready_txns);
//    vector<Key> key1, none;
//    vector<TxnProto*> owners;
...
//  TEST(LockManagerTest, ThroughputTest) {
//    deque<TxnProto*> ready_txns;
//    Configuration config(0, "common/configuration_test_one_node.conf");
//    LockManager lm(&ready_txns, &config);
