...
#ifndef _DB_CHECKPOINTING_NAIVE_H_
#define _DB_CHECKPOINTING_NAIVE_H_
...
/// @brief Capturing naive snapshots from the database
///
/// The NaiveCheckpointer is a dummy checkpointer, which does nothing on
...
class NaiveCheckpointer : public Checkpointer {
 public:
  ...
  /// The NaiveCheckpointer frees only it's decorator if it was given one
  virtual ~NaiveCheckpointer() {}
...
#endif  // _DB_CHECKPOINTING_NAIVE_H_
