...
/// @section DESCRIPTION
///
/// Mutex implementing Lock, TryLock, Unlock. Currently a thin wrapper around
/// pthread_mutex_t, but this is apt to change in the future to a (better?)
/// implementation, so please use this Mutex class rather then pthread_mutex_t
/// for critical sections in Calvin.
///
...
#ifndef _DB_COMMON_MUTEX_H_
#define _DB_COMMON_MUTEX_H_
